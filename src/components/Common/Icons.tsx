import { Rss, Mail, FileText, ExternalLink } from 'lucide-react'

// Manual SVGs for Brand Icons since Lucide v1 removed them
...
export const LivePhotoIcon = ({ size = 14, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
