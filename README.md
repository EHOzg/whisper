...
> "In the silence, we find the most profound echoes."

**Whisper** is a minimalist, high-end personal digital space designed to capture thoughts, archive writings, and present a professional identity with intentionality and elegance. Built with the latest web technologies, it prioritizes typography, negative space, and fluid interactions to create a premium user experience.
...
/
├── src/
│   ├── components/      # Atomic UI components (Brand, Navigation, etc.)
│   ├── content/         # MDX/JSON data for Archive and Inspirations
│   ├── i18n/            # Internationalization configuration
│   ├── layouts/         # Shared page structures
│   ├── modules/         # Feature-specific logic (Inspiration canvas)
│   ├── pages/           # Astro routes (Archive, Resume, Home)
